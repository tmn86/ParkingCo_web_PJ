...
<!-- Error message -->
    <div class="row" style="margin: auto">
      <div class="col-lg-12 text-center">
          <p class="display-4 mt-5 border-top"><h2>Oops!</h2></p>
          <p><small>Something went wrong. Please try again later!</small></p>
      </div>
      <div class="col-lg-12">
        <img src="images/red.png" class="text-center img-responsive" style="width: 4%; margin-left: 48%;">         
      </div>      
      <div class="col-lg-12 text-center mt-5" >
        <a href="homepage1.html">Back To Homepage</a>
      </div>  
    </div>
